...
<office:document
 ...
 <office:meta>
  <meta:creation-date>{{horodate.isoformat()}}</meta:creation-date>
  <dc:date>{{horodate.isoformat()}}</dc:date>
  <meta:editing-duration>PT33S</meta:editing-duration>
  <meta:editing-cycles>1</meta:editing-cycles>
  <meta:document-statistic meta:table-count="2" meta:cell-count="3" meta:object-count="0"/>
  <meta:generator>societaires.py</meta:generator>
 </office:meta>
 <office:settings>
   ...
   <config:config-item-map-indexed config:name="Views">
    <config:config-item-map-entry>
     ...
     <config:config-item-map-named config:name="Tables">
      <config:config-item-map-entry config:name="personnes">
     ...
     <config:config-item config:name="ActiveTable" config:type="string">personnes</config:config-item>
     <config:config-item config:name="HorizontalScrollbarWidth" config:type="int">1297</config:config-item>
     <config:config-item config:name="ZoomType" config:type="short">0</config:config-item>
     <config:config-item config:name="ZoomValue" config:type="int">100</config:config-item>
     <config:config-item config:name="PageViewZoomValue" config:type="int">60</config:config-item>
 ...
 <office:master-styles>
  ...
  <style:master-page style:name="Report" style:page-layout-name="pm2">
   <style:header>
    ...
    <style:region-right>
     <text:p><text:date style:data-style-name="N2" text:date-value="{{horodate.strftime('%Y-%m-%d')}}">00/00/0000</text:date>, <text:time>00:00:00</text:time></text:p>
    </style:region-right>
   </style:header>
   <style:header-left style:display="false"/>
   <style:footer>
 ...
 <office:body>
  ...
  <!-- Second table: participations -->
   <table:table table:name="participations" table:style-name="ta1">
    <table:table-column table:style-name="co1" table:number-columns-repeated="3" table:default-cell-style-name="Default"/>
	<!-- first row: fields -->
    <table:table-row table:style-name="ro1">
	 % for key in participations[0].keys():
     <table:table-cell office:value-type="string" calcext:value-type="string">
      <text:p>{{key}}</text:p>
     </table:table-cell>
	 % end
